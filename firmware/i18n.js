...
var I18N = {
  fr: {
    ...
    'settings.design_style': 'Thème',
    'settings.style_sonos':  'Sonos',
    'settings.style_soft':   'Soft',
    'settings.style_simple': 'Simple',
    'settings.color_mode': 'Apparence',
  ...
  en: {
    ...
    'settings.design_style': 'Theme',
    'settings.style_sonos':  'Sonos',
    'settings.style_soft':   'Soft',
    'settings.style_simple': 'Simple',
    'settings.color_mode': 'Appearance',
  ...
  es: {
    ...
    'settings.design_style': 'Tema',
    'settings.style_sonos':  'Sonos',
    'settings.style_soft':   'Suave',
    'settings.style_simple': 'Simple',
    'settings.color_mode': 'Apariencia',
    'settings.theme':      'Tema',
    'settings.theme_auto': 'Auto',
